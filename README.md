...
You can now visit [http://localhost:5000/](http://localhost:5000/) and start developing.
...
* start the web app that can communicate with the database on [http://localhost:5000/](http://localhost:5000/]
